...
void setup() {
  ...
  attachInterrupt(digitalPinToInterrupt(PIN_ENCODER_A), ISR_encoderPIN_A, CHANGE);
  attachInterrupt(digitalPinToInterrupt(PIN_ENCODER_B), ISR_encoderPIN_B, CHANGE);
}
